...
This portfolio was created for VIS 2128: Spatial Analysis, a course within the Harvard Graduate School of Design's Master in Urban Planning (MUP) Program. The visualizations within this portfolio demonstrate the skills I have developed in using ArcGIS and RStudio this semester.  

For this portfolio, I am the products of several assignments this semester in which I was able to gather data from municipal open data portals and explore topics of interest to me. Specifically, this portfolio features maps of Tokyo (Japan), Detroit (Michigan), New Orleans (Louisiana), and my home region of New Haven County (Connecticut).  
...
[![](thumbnails/Tokyo Georeference 3 - Fuel Stations and Highway Routes10241024_1.png)](https://abrazak95.github.io/portfolio//fullsize/Tokyo Georeference 3 - Fuel Stations and Highway Routes.pdf){target="_blank"}
...
[![](thumbnails/DetroitNeighborhoodsHistoric.png)](https://abrazak95.github.io/portfolio//fullsize/DetroitNeighborhoodsHistoric.pdf){target="_blank"}
...
[![](thumbnails/DetroitHoodsDemolition.png)](https://abrazak95.github.io/portfolio//fullsize/DetroitHoodsDemolition.pdf){target="_blank"}
...
This map shows the area within each of a set of cutoff walking times to the evacuation locations. The map shows the transit travel time with in 10, 20, and 30 minutes.   

[![](thumbnails/NewOrleansEvacIso.png)](https://abrazak95.github.io/portfolio//fullsize/NewOrleansEvacIso.pdf){target="_blank"}
...
[![](thumbnails/NewOrleansRasterize.png)](https://abrazak95.github.io/portfolio//fullsize/NewOrleansRasterize.pdf){target="_blank"}
...
[![](thumbnails/NewOrleansRasterStreets.png)](https://abrazak95.github.io/portfolio//fullsize/NewOrleansRasterStreets.pdf){target="_blank"}
...
[![](thumbnails/New Haven County_Interactive.png)](https://abrazak95.github.io/portfolio//fullsize/Black_Boys_GNH.html){target="_blank"}
